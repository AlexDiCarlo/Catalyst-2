...
function CollagePB(props:any){
    ...
    return (
        <div className={`relative t ${content.panel_bg_color} ${content.add_margin_padding.margin_top_bottom_mobile} ${content.add_margin_padding.margin_top_bottom_desktop} {{hmb_p}`} data-nqe-widget="collage">
            <div className={`relative ${content.add_margin_padding.padding_top_bottom_mobile} ${content.add_margin_padding.padding_top_bottom_desktop}`}>
                <div className={`${content.page_width}`}>
                    {content.panel_title && content.panel_title.value != "" ? 
                        <h2 className={`px-2 py-4  ${content.panel_title.font_size} ${content.panel_title.color} ${content.panel_title.font_style} ${content.panel_title.font_weight} ${content.title_align} brand-font`}>{content.panel_title.value}</h2>    
                    :null}
